...
import Albumcover from "../media/Planet-Q-Radio.gif";
import Album1 from "../media/album1.webp";
import Album2 from "../media/album2.webp";
import AntoniaMarquee from "../media/album3.webp";
...
import TamrynSouthern from "../media/tamryn.jpeg";
import PrincessSuperstar from "../media/princess.jpeg";
...
const Radio = () => {
  ...
  <Img src={Albumcover} alt="" />
      <Album>
        ...
        <Img src={TamrynSouthern} alt="" />
        <Box sx={{ width: "100%", marginTop: '-4px'}}>
          <iframe
            title="radio"
            style={{ borderRadius: "0px" }}
            src="https://open.spotify.com/embed/track/4EGP1CTbD3vYTZtB4XP0cz?utm_source=generator"
            width="100%"
            height="80"
            frameBorder="0"
            allowfullscreen=""
